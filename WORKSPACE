...
http_file(
    ...
    urls = ["https://github.com/rmohr/bazeldnf/releases/download/v1.2.3/bazeldnf-v1.2.3-linux-amd64"],
)
...
http_file(
    ...
    urls = ["https://github.com/rmohr/bazeldnf/releases/download/v1.2.3/bazeldnf-v1.2.3-linux-arm64"],
)
